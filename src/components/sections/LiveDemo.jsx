      ...
      <div className="mx-auto max-w-3xl px-6">
        <Reveal className="text-center">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            Ask a question about Amir's work. The answer is generated by a small
            retrieval-augmented pipeline — a real OpenAI API call, grounded only in
            this site's own content, running on a rate-limited serverless backend.
          </p>
        </Reveal>
